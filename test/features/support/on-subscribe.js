...
Given(/^SP has previously sent a subscribe request to FR$/, function () {
  specSubscribe = spec(); // Initialize the specSearch object
});

When(/^FR completes processing and calls SP on-subscribe callback$/, async function () {
  try {
...
Then(/^SP should receive the on-subscribe response from FR$/, async function () {
