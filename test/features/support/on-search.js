...
Given(/^SP has previously sent a search request to FR$/, function () {
  speconSearch = spec(); // Initialize the specSearch object
});

When(/^FR completes processing and calls SP on-search callback$/, async function () {
  try {
...
Then(/^SP should receive the on-search response from FR$/, async function () {
